...
const HomePageCasino = () => {  var defaultmatchSettings = {
  dots: false,
  infinite: true,
  speed: 500,
  slidesToShow: 2,
      ...
      <div className="my-3">
        <div className="casino-area-start">
          {loader ? (
            ...
            <>
              <h5 className="font-14 mb-3">Slots Games</h5>
              <div className="casino-all-data">
                {casinoData?.content?.gameList?.length > 0
                  ? _.sampleSize(casinoData?.content?.gameList, 8)?.map(
                      (item) => (
                        <>
                          <div
              ...
              <h5 className="font-14 mb-3 mt-3">Live Casino</h5>
              <div className="casino-all-data">
                {casinoData?.content?.gameList?.length > 0 ? (
                  <>
                    {_.sampleSize(casinoData?.content?.gameList, 8)?.map(
              ...
              <h5 className="font-14 mb-3 mt-3">Games</h5>
              <div className="casino-all-data">
                {casinoData?.content?.gameList?.length > 0 ? (
                  <>
                    {_.sampleSize(casinoData?.content?.gameList, 8)?.map(
